...
class GameProper(QWidget):
    ...
    def dead(this,self):
        ...
        question = QMessageBox.question(GameWindow, "Exit Game?", "Do you want to continue?")
    ...
    def SaveAndExitGame(this,self):
        ...
        if question == QMessageBox.Yes:
            ...
            save.write(str(this.PlayerName) + "\n" + str(this.HPPlayer) + "\n" + str(this.HPEnemy) + "\n" + str(this.MaxHPEnemy) + "\n" + str(this.EnemyName) + "\n" + str(this.Enum) + "\n" + str(this.Defeated))
            save.close()
...
class Ui_LoadGameWindow(object):
    def setupUi(self, GameWindow):
        ...
        Gamering = GameProper(int(info[5]),int(info[6]),int(info[1]),int(info[2]),info[4],info[0],100,info[3])
        ...
        self.Health.setText(info[1]+"/100")
        ...
        self.EnemyHealth.setText(info[2]+'/'+info[3])
        ...
        self.PlayerName.setText(info[0])
